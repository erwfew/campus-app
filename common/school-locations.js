...
const SCALE = { x: 0.0005, y: 0.0005 }   // 不使用，保留兼容

// 每个校区的GPS参考点 + 从已知锚点反推的真实比例尺
// 1号校区锚点：
//   南门(8,0) → (120.074260, 30.253663)
//   3号教师公寓(11,7) → (120.074935, 30.254384)
//   7幢学生公寓(10,5) → (120.075003, 30.254150)
//   → lng/单位 = (120.074935-120.074260)/(11-8) = 0.000225
//   → lat/单位 = (30.254384-30.253663)/(7-0) = 0.000103
const CAMPUS_GPS = {
  '1号校区': { refLng: 120.074260, refLat: 30.253663, refX: 8, refY: 0, scaleX: 0.000225, scaleY: 0.000103 },
  // 2号校区用已知中心点，比例尺与1号校区相同
  '2号校区': { refLng: 120.076538, refLat: 30.258425, refX: 6, refY: 6, scaleX: 0.000225, scaleY: 0.000103 },
}
...
function xyToGps(campusName, x, y) {
  ...
  return {
    lng: gps.refLng + (x - gps.refX) * gps.scaleX,
    lat: gps.refLat + (y - gps.refY) * gps.scaleY,
  }
}
